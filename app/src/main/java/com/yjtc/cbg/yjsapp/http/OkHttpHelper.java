...
public class OkHttpHelper {
    ...
    public void get(String url,HashMap<String,Object> params, BaseCallback callback) {
    ...
    private Request buildGetRequest(String url,HashMap<String,Object> params) {
    ...
    private RequestBody builderFormData(Map<String, Object> params) {
        ...
        if (params != null) {
            ...
            MyApplication mpp = MyApplication.getInstanse();
            String token ="";// MyApplication.getInstanse().getToken();
